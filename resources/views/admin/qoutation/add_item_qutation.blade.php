...
@endpush
@section('page_title', 'Add New Item Quotation')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <form action="{{ route('item_qutation_store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-2">
                                    <tr>
                                ...
                                <div class="col-2">
                                    <tr>
                                        <td>Qoutation No</td>
                                        <td>
                                            <input type="text" name="qoutation_no" value="{{ qoutation_no() }}" class="form-control">
                                        </td>
                                    </tr>
                                </div>
                                <div class="col-2">
                                ...
                                <span>Sub: </span> <input type="text" name="sub" class="form-control" id="unit"
                                    ...
                                    <table class="table table-bordered" id="dynamic-table">
                                          ...
                                          <tr class="text-center">
                                                ...
                                                {{--<td id="size_id">     
                                                <input type="text" class="form-control size-no" name="size_no[]">                   
                                                </td>--}}
