            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    <table class="table table-bordered" style="width:30%">
                        <tr>
                            <td> Name</td>
                            <td>{{$sales_transacion->supplier->name}}</td>
                        </tr>
                        <tr>
                            <td>Phone</td>
                            <td>{{$sales_transacion->supplier->phone}}</td>
                        </tr>
                        <tr>
                            <td>Address</td>
                            <td>{{$sales_transacion->supplier->address}}</td>
                        </tr>
                    </table>
                    ...
                    <table class="table table-bordered" style="width:30%">
                        ...
                        <tr>
                              <td>Email</td>
                              <td>{{ $sales_transacion->supplier->email }}</td>
                        </tr>
