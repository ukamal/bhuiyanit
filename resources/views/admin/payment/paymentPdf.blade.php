            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between">
                    <table class="table table-bordered" style="width:30%">
                        <tr>
                            <td> Name</td>
                            <td>{{$sales_transacion->customer->customer}}</td>
                        </tr>
                        <tr>
                            <td>Phone</td>
                            <td>{{$sales_transacion->customer->phone}}</td>
                        </tr>
                        <tr>
                            <td>Address</td>
                            <td>{{$sales_transacion->customer->address}}</td>
                        </tr>
                    </table>
                    ...
                    <table class="table table-bordered" style="width:30%">
                        <tr>
                            <td>Date</td>
                            <td>{{ \Carbon\Carbon::parse($sales_transacion->date)->format('d-m-Y') }}</td>
                        </tr>
                        <tr>
                              <td>Email</td>
                              <td>{{ $sales_transacion->customer->email }}</td>
                        </tr>
                ...
                <div>
                    <table class="table table-bordered">
                        ...
                        <tr>
                              <td>#</td>
                              <td>{{ $sales_transacion->description }}</td>
                              <td>{{ $sales_transacion->receive_amount }}</td>
                        </tr>
