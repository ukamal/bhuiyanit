...
@endpush
@section('page_title', 'Receive Payment')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="modal fade" id="customer_modal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.customer.receive.payment.store') }}" method="POST">
                                        @csrf
                        ...
                        <div class="table-responsive">
                            <table class="display table table-striped table-bordered" id="zero_configuration_table"
                                ...
                                <tbody>
                                    @foreach ($sales_transacion as $key=>$transaction)
                                        <tr>
                                            <td>{{$key+1}}</td>
                                            <td>{{$transaction->customer->customer}}</td>
                                            <td>{{ \Carbon\Carbon::parse($transaction->date)->format('d-m-Y') }}</td>
                                            <td>{{$transaction->receive_amount}}</td>
                                            <td>{{$transaction->description}}</td>
                                            <td>
                                                <a class="btn btn-primary" href="{{ route('receive_payment_print',$transaction->id)}}">Print</a>
                                            </td>
                                            {{--<td>
