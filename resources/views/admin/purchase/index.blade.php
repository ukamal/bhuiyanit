                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <tr>
                                        <td>PO No</td> <br>
                                        <td>
                                            <input type="text" name="purchase_no" value="{{ generate_purchase_no() }}" class="form-control">
                                        </td>
                                    </tr>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <td>
                                        <select class="form-control select2 product-select" name="prosize_id[]" data-row="1">
                                            ...
                                            @foreach ($products as $pro)
                                                <option value="{{ $pro->id }}">
                                                {{ $pro->code }} - {{ $pro['brand']['brand_name'] }} - {{ $pro->product_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </td>
        ...
        $("#add-row").on("click", function () {
            ...
            var newRow = '<tr>' +
                ...
                '<select class="form-control product-select text-center" name="prosize_id[]" data-row="' + rowCounter + '">' +
                    '<option value="">Select Item</option>' +
                    '@foreach ($products as $pro)' +
                        '<option value="{{ $pro->id }}">{{ $pro->code }} - {{ $pro['brand']['brand_name'] }} - {{ $pro->product_name }}</option>' +
                    '@endforeach' +
                '</select>' +
                '</td>' +
                '<td>' +
