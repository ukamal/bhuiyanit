        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        <h4 class="card-title mb-3">Package Sale List</h4>
                        <div>
                                ...
                                <tbody>
                                    @foreach ($sales as $key => $order)
                                        <tr>
                                            ...
                                            <td><a href="{{route('admin.sale_details',$order->id)}}" class="btn btn-primary">View</a>
                                            <a href="{{route('admin.sale_details_print',$order->id)}}" class="btn btn-primary">Bill Print</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
