            ...
            <div class="card mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.service_sales.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <tr>
                                        <td>Invoice No</td>
                                        <td>
                                            <input type="text" name="service_sale_no" value="{{ sale_no() }}" class="form-control">
                                        </td>
                                    </tr>
                                </div>
                                <div class="col-md-4">
