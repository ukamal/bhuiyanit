        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        <h4 class="card-title mb-3">Add New Qoutation</h4>
                                ...
                                <div class="col-lg-4">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{qoutation_no()}}
                                                <input type="text" name="qoutation_no" value="{{sale_no()}}"  hidden>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Customer Name</td>
                                            <td>
                                                <div class="form-group">
                                                    <select class="form-control" onchange="get_customer()" id="customer" name="customer">
                            ...
                            <div>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <button type="submit" class="btn btn-primary">Confirm Qoutation</button>
                                    </div>
                                </div>
                            </div>
                        </form>
