        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        <h4 class="card-title mb-3">Add New Sale</h4>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-3">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="sale_no" value="<?php echo e(sale_no()); ?>" class="form-control">
                                        </td>
                                    </tr>
                                </div>
                          ...
                          <table class="table table-bordered" id="dynamic-table">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <select class="form-control product-select select2" name="prosize_id[]" data-row="1">
...
<?php $__env->startPush('vue-js'); ?>
<script src="<?php echo e(asset('js/pages/AddNewSale.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/backup-projets/bhuiyanit/resources/views/admin/sales/index.blade.php ENDPATH**/ ?>