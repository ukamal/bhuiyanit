                    ...
                    <div class="card-body">
                        ...
                        <div class="modal fade" id="customer_modal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo e(route('admin.supplier.payment.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                        ...
                        <div class="table-responsive">
                            <table class="display table table-striped table-bordered" id="zero_configuration_table"
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $SupplierTransaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="<?php echo e(route('supplier_payment_print',$transaction->id)); ?>">Print</a>
                                            </td>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/backup-projets/bhuiyanit/resources/views/admin/order/supplier_payment.blade.php ENDPATH**/ ?>