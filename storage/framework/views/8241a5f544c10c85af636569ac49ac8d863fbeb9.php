                                ...
                                <tbody>
                                    <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(\Carbon\Carbon::parse($order->sale_date)->format('d-m-Y')); ?></td>
                                            <td><?php echo e($order->qoutation_no); ?></td>
                                            <td><?php echo e($order->customer->customer); ?></td>
                                            <td><?php echo e($order->grandTotal); ?></td>
                                            <td><a href="<?php echo e(route('admin.qoutation_details',$order->id)); ?>" class="btn btn-primary">View</a>
                                            <a href="<?php echo e(route('admin.qoutation_details_print',$order->id)); ?>" class="btn btn-primary">PDF</a></td>
                                        </tr>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/backup-projets/bhuiyanit/resources/views/admin/qoutation/sale_list.blade.php ENDPATH**/ ?>