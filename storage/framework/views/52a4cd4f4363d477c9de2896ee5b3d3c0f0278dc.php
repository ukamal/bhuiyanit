...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('page_title', 'Expense List'); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($expense->head); ?></td>
                                            <td><?php echo e($expense->description); ?></td>
                                            <td>
                                                <a href="#" class="btn btn-danger" data-toggle="modal"
                                                    data-target="#delete_modal<?php echo e($expense->id); ?>">x</a>
                                                <div class="modal fade" id="delete_modal<?php echo e($expense->id); ?>"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-dismiss="modal">Close</button>
                                                                <a href="<?php echo e(route('expense_destroy', $expense->id)); ?>"
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/backup-projets/bhuiyanit/resources/views/admin/expense/index.blade.php ENDPATH**/ ?>