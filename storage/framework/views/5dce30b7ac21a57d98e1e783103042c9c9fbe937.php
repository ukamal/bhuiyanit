<?php $__env->startSection('title', 'Customer Order List'); ?>
<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('backend/dist-assets/css/plugins/datatables.min.css')); ?>" />
<?php $__env->stopPush(); ?>
<?php $__env->startSection('page_title', 'Customer Order List'); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($order->customer_comm); ?></td>
                                            <?php
                                                $receive_amount=$order->grandTotal-$order->customer_comm;
                                            ?>
                                            <td><?php echo e($receive_amount); ?></td>
                                            <td><?php echo e($order->customer_advence); ?></td>
                                            <td><?php echo e($receive_amount-$order->customer_advence); ?></td>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/backup-projets/bhuiyanit/resources/views/admin/order/cutomer_order_list.blade.php ENDPATH**/ ?>