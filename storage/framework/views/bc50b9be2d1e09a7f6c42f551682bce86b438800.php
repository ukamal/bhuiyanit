        ...
        <div class="dropdown dropleft"><i class="i-Safe-Box text-muted header-icon" id="dropdownMenuButton" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <div class="menu-icon-grid">
                    ...
                    document.getElementById('logout-form').submit();"><i class="text-20 i-Power-2"></i>Log Out</a>
...
<?php /**PATH /home/user/backup/remote/webbysys/bhuiyanit/resources/views/layouts/backend/parts/header.blade.php ENDPATH**/ ?>