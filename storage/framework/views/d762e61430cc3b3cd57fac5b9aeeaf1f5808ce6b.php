...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('page_title', 'Add New Service Quotation'); ?>
            ...
            <div class="card mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.qoutation.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-2">
                                    <tr>
                                ...
                                <div class="col-2">
                                    <tr>
                                        <td>Quotation No</td>
                                        <td>
                                            <input type="text" name="qoutation_no" value="<?php echo e(sale_no()); ?>" class="form-control">
                                        </td>
                                    </tr>
                                </div>
                                <div class="col-2">
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/backup-projets/bhuiyanit/resources/views/admin/qoutation/index.blade.php ENDPATH**/ ?>