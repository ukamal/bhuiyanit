...
<?php $__env->startSection('title', 'Add new Purchase'); ?>
<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('backend/dist-assets/css/plugins/datatables.min.css')); ?>" />
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
<?php $__env->stopPush(); ?>
<?php $__env->startSection('page_title', 'Add New Purchase'); ?>
<?php $__env->startSection('content'); ?>
    <div class="row" id="add_new_purchase">
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        <h4 class="card-title mb-3">Add New Purchase</h4>
                  
                        <form action="<?php echo e(route('purchase_store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-3">
                                    <tr>
                                        <td>PO No</td> <br>
                                        <td>
                                            <input type="text" name="purchase_no" value="<?php echo e(generate_purchase_no()); ?>" class="form-control">
                                        </td>
                                    </tr>
                                </div>
                                <div class="col-md-3">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group" style="display:flex">
                                                <select class="form-control" onchange="getSupplierInPurchase()" id="supplier_name" name="supplier_id">
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="supplier_mobile" id="supplier_mobile" placeholder="Mobile">
                                                <?php $__errorArgs = ['supplier_mobile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <table class="table table-bordered" id="dynamic-table">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <input type="number" name="qty[]" class="form-control qty" oninput="calculateAmount()">
                                    </td>
    ...
    $(document).ready(function () {
        ...
        $("#add-row").on("click", function () {
            ...
            var newRow = '<tr>' +
                '<td>' + rowCounter + '</td>' +
                '<td>' +
                '<select class="form-control product-select text-center" name="prosize_id[]" data-row="' + rowCounter + '">' +
                    '<option value="">Select Item</option>' +
                    '<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>' +
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/backup-projets/bhuiyanit/resources/views/admin/purchase/index.blade.php ENDPATH**/ ?>